package com.artificer.osworks.domain.model;
...
import com.artificer.osworks.domain.ValidationGroups;
...
public class OrdemServico {
	...
	public void cancelar() {
		...
		if (naoPodeSerFinalizada()) {
			throw new NegocioException("A Ordem de Serviço não pode ser cancelada!");
		}
